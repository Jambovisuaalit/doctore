...
class MarketContractAdapterTests(unittest.TestCase):
    ...
    def test_soccer_is_normalized_but_fail_closed_without_verified_settlement(self) -> None:
        outcomes = [
        ...
        self.assertIsNone(result["domain"]["settlement_rules"])
    ...
    def test_tennis_is_normalized_but_retirement_rule_stays_unverified(self) -> None:
        outcomes = [
        ...
        self.assertIn("TENNIS_RETIREMENT_SETTLEMENT_UNVERIFIED", result["reason_codes"])
        self.assertIsNone(result["market_snapshot"])
